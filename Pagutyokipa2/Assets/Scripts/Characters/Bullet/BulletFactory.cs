...
namespace Ryocatusn.Characters
{
    ...
    {
        public static Bullet Create(Bullet prefab, AttackableObjectId id, Vector2 position, Quaternion rotation)
        {
            Bullet bullet = GameObject.Instantiate(prefab, position, rotation);
            bullet.SetUp(id);
            return bullet;
        }
        public static Bullet Create(Bullet prefab, AttackableObjectId id, Vector2 position, Transform target)
        {
        ...
        public static Bullet Create(Bullet prefab, AttackableObjectId id, Vector2 position, TileDirection.Direction direction)
        {
